class ProcessEmailJob < ApplicationJob
  ...
  def perform(uploaded_file)
    email_content = uploaded_file.file.blob.download
    ...
    begin
      ...
      if parser.processing_failed?
        ...
        log.update!(
          status: :success,
          message: "Sucesso! Customer criado. Assunto: #{parser.subject}",
          extracted_data: parser.to_h_of_extracted_data
        )
